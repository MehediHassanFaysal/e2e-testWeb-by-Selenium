...
public class cashWithdrawTransactionHistoryPage {
    ...
    @FindBy(xpath = "//a[normalize-space()='Cash Withdraw Transactions']") public WebElement navToCashWithdrawTransactionHistory;
